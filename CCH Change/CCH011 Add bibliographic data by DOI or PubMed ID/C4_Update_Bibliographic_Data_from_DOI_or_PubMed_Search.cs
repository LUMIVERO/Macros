	...
	public static void Main()
	{
		...
		try 
		{
			...
			foreach (Reference reference in referencesWithDoi)
			{
				...
				var lookedUpReference = identifierSupport.FindReference(activeProject, new ReferenceIdentifier() { Type = ReferenceIdentifierType.PubMedId, Value = reference.PubMedId }, true, null);
				if (lookedUpReference == null) 	lookedUpReference = identifierSupport.FindReference(activeProject, new ReferenceIdentifier() { Type = ReferenceIdentifierType.Doi, Value = reference.Doi }, true, null);
