...
public static class CitaviMacro
{
	...
	{
		//****************************************************************************************************************
		// CHANGE NUMBERING TYPE FOR ALL SELECTED REFERENCES
		// 1.0 -- 2020-03-09
		//
		// This macro changes the numbering type of the page ranges from "Pages" and other to "Margin numbers".
		//
		// EDIT HERE
		...
		foreach (Reference reference in references)
		{
                ...
                try
                {
                    if (reference.PageRange.NumberingType != NumberingType.Margin)
                    {
                        PageRange newPageRange = referencePageRange.Update(NumberingType.Margin);    
